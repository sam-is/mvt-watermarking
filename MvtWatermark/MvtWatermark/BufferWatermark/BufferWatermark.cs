...
public class BufferWatermark: IMvtWatermark
{
    ...
    public VectorTileTree Embed(VectorTileTree tiles, int key, BitArray message)
    {
        ...
        var bwmMapboxTileWriterWm = new BwmMapboxTileWriterWm();
        var tileDict = bwmMapboxTileWriterWm.WriteWm(tiles, message, firstHalfOfTheKey, _options, out _embededMessage);

        var readerWm = new BwmMapboxTileReaderWm();
